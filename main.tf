...
resource "aws_instance" "my_instance" {
  ...
  user_data = <<-EOF
              ...
              docker run -d --name my-app-containernew --log-driver awslogs --log-opt awslogs-region=ap-southeast-2 --log-opt awslogs-group=docker-logs --log-opt awslogs-create-group=true -p 80:80 agri-pass-backend-image
              EOF
}
